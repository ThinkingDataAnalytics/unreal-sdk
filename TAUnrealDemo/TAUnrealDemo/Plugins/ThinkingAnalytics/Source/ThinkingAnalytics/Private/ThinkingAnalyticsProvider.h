...
class FAnalyticsProviderThinkingAnalytics :
  public IAnalyticsProvider
{
    ...
    FAnalyticsProviderThinkingAnalytics();
...
public:
...

    {
        if (!Provider.IsValid())
        {
            Provider = TSharedPtr<IAnalyticsProvider>(new FAnalyticsProviderThinkingAnalytics());
        }
        return Provider;
    }
	...
	static TSharedPtr<FAnalyticsProviderThinkingAnalytics> GetProvider() 
    {
		return StaticCastSharedPtr<FAnalyticsProviderThinkingAnalytics>(Provider);
	}

    virtual ~FAnalyticsProviderThinkingAnalytics();
